...
{
    /// <inheritdoc />
    public partial class initialAllProjectfromoldlaptop : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstituteName = table.Column<string>(type: "nvarchar(200)", nullable: true),
                    ContactNo_1 = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    ContactNo_2 = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    ...
                    StateCode = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    GSTNo = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    PanNo = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    UANNo = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    BankAccName = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    BankAccNo = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    ...
                    Signature = table.Column<string>(type: "nvarchar(500)", nullable: true),
                    TermsAndCondition = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ParentId = table.Column<string>(type: "nvarchar(200)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAccountConfirmations", x => x.id);
                    table.ForeignKey(
                        name: "FK_UserAccountConfirmations_AspNetUsers_UserAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAccountConfirmations_UserAccountId",
                table: "UserAccountConfirmations",
