...
function WeeklyAllDealerSale(result) {
...
function WeeklyAdminSale(result) {
    ...
    var chart55 = new ApexCharts(document.querySelector("#user-activation-dash-3"), options55);
    chart55.render();
}
function WeeklyDealerWiseSale(result) {
    ...
    var chart55 = new ApexCharts(document.querySelector("#user-activation-dash-4"), options55);
    chart55.render();
}
